...
def publish_markers(output_dicts, pub_detected_objects, pub_detected_class, class_names):
    ...
    # publish two topics
    pub_detected_objects.publish(center_markers)
...
def main():
    ...
    rospy.init_node('VoxelNeXt_center_object_detect', anonymous=False)
    ...
    pub_detected_objects = rospy.Publisher('/detected_center', MarkerArray, queue_size=10)
