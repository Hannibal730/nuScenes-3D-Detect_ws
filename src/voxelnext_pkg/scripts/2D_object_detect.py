...
def main():
    ...
    rospy.init_node('VoxelNeXt_2D_object_detect', anonymous=False)
    ...
    # Create a ROS publisher for detected objects
    pub_detected_objects = rospy.Publisher('/detected_2D_Box', MarkerArray, queue_size=10)
