...
class VoxelResBackBone8xVoxelNeXt(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        # Original
        # it's for modifying grid_size [nx, ny, nz] to [nz, ny, nx, 1, 0, 0]
        #self.sparse_shape = grid_size[::-1] + [1, 0, 0]

        # ✅ Modified
        # it's for modifying grid size [nx, ny, nz] to [z, y, x] 
        self.sparse_shape = [grid_size[2] + 1, grid_size[1], grid_size[0]]
        
        # ✅ DEBUGGING
        # print(f"🔍 DEBUG - grid_size: {grid_size}, sparse_shape: {self.sparse_shape}")

        # ✅ DEBUGGING
        assert len(self.sparse_shape) == 3, f"❌ ERROR: sparse_shape {self.sparse_shape} does not match expected ndim (3)"
    ...
    def forward(self, batch_dict):
        ...
        input_sp_tensor = spconv.SparseConvTensor(
            ...
            # ✅ MOdified
            spatial_shape=self.sparse_shape[:3],
